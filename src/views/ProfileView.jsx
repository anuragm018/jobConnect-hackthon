    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '40px' }}>
      ...
      <div style={{ background: 'linear-gradient(180deg, rgba(238, 242, 255, 0.4) 0%, var(--bg-primary) 100%)', padding: '48px', borderRadius: '24px', display: 'flex', alignItems: 'center', gap: '32px', marginBottom: '40px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <h1 style={{ fontSize: '2.5rem', fontWeight: '800', margin: 0, color: 'var(--text-primary)', letterSpacing: '-0.5px' }}>{profile.name}</h1>
          ...
          <div style={{ display: 'flex', gap: '32px', color: 'var(--text-secondary)', fontSize: '1rem', fontWeight: '500' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><MapPin size={18} color="var(--accent-primary)" strokeWidth={2.5} /> {profile.location || 'Location Not Set'}</span>
            <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><Calendar size={18} color="var(--accent-primary)" strokeWidth={2.5} /> Member since 2024</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '56px' }}>
        <div className="glass-panel" style={{ padding: '32px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--bg-glass)', borderRadius: '20px', border: '1px solid var(--border-glass)', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
          <div>
            <div style={{ color: 'var(--text-secondary)', fontSize: '1rem', fontWeight: '600', marginBottom: '12px' }}>Total Bookings</div>
            <div style={{ fontSize: '2.8rem', fontWeight: '800', color: '#1e40af', lineHeight: '1' }}>4</div>
          </div>
        ...
        <div className="glass-panel" style={{ padding: '32px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--bg-glass)', borderRadius: '20px', border: '1px solid var(--border-glass)', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
          <div>
            ...
            <div style={{ fontSize: '2.8rem', fontWeight: '800', color: '#b45309', lineHeight: '1' }}>0</div>
          </div>
